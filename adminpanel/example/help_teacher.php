...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insert_query = "INSERT INTO help_teacher (add_teacher_help) VALUES (?)";
    $insert_stmt = $conn->prepare($insert_query);

    if ($insert_stmt) {
        $insert_stmt->bind_param("s", $t_text);
        $insert_stmt->execute();
        $insert_stmt->close();
...
<body class="">
  <div class="wrapper">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card demo-icons">
              ...
              <!-- form start  -->
              <form action="help_teacher.php" method="post">
                <div class="card-header">
                  <div class="container">
                    ...
                    <div id="contact">
                      <fieldset>
                        <p style="text-align: center;color: #ff9d5c; font-size: 30px;font-weight: bold; ">Add Help for Teacher Panel</p>
    ...
    <input type="submit" id="submit" value="Submit Teacher Help" style="font-size: 15px;font-weight:bold;margin-bottom:1rem; padding: 10px 25px; background-color: #ff9d5c; color: white; border-radius: 8px; border: #ff9d5c;" />
</form>
