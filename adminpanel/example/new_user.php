                ...
                <div class="container">
                  ...
                  <div id="contact">
                    ...
                    <fieldset>
                      ...
                      <input placeholder="Enter Email / Username" id="email" type="text" tabindex="1" required autofocus />
                    </fieldset>
                    <br />

                    <fieldset>
                      <p style="color: #ff9d5c; font-size: 22px;font-weight: bold; ">Password</p>
                      <input placeholder="Enter Password" id="password" type="text" tabindex="1" required autofocus />
                    </fieldset>
                    <br />
