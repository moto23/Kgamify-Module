                ...
                <div class="card-header">
                  <div class="container">
                    ...
                    <div id="contact">
                      ...
                      <input style="border-color: #ff9d5c; width: 100%;" placeholder="" name="description" id="description" type="text" tabindex="1" autofocus />
                      ...
                      <fieldset>
                        ...
                        <input placeholder="Enter Number of Questions" id="n_questions" type="number" name="no_of_questions" tabindex="1" required autofocus />
                      </fieldset>
                      <br />
                      ...
                      <fieldset>
                        ...
                        <input placeholder="Enter Time Required (In Minutes)" id="t_required" type="text" tabindex="1" name="time_required" required autofocus />
                      </fieldset>
                      <br />
