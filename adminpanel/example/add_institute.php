...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['institute_name']) && isset($_POST['institute_abbreviation'])) {
        $institute_name = $_POST['institute_name'];
        $institute_abbr = $_POST['institute_abbreviation'];
        ...
        $stmt = $conn->prepare("SELECT COUNT(*) FROM institute WHERE institute_name = ?");
        if ($stmt) {
            ...
            if ($count > 0) {
                echo "<script>alert('Institute name already exists');
                window.location.href = 'add_institute.php';
                </script>";
            } else {
                // Use prepared statement to insert data safely
                $stmt = $conn->prepare("INSERT INTO institute (institute_name,institute_abbreviation,institute_address,institute_url) VALUES (?,?,?,?)");

                // Check if the statement was prepared successfully
                if ($stmt) {
                    $stmt->bind_param("ssss", $institute_name,$institute_abbr, $institute_address, $institute_url);
                ...
                $query="UPDATE institute set unique_id='".$unique_id."' where institute_id='".$last_id."'";
        ...
        echo "<script>alert('Institute Name and Abbreviation are required');
                window.location.href = 'add_institute.php';
                </script>";
    }
}
...
<head>
    ...
    <title>NEW INSTITUTE | PlayQuest</title>
...
<body>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card demo-icons">
                            ...
                            <!-- form start  -->
                            <form action="add_institute.php" method="post">
                                <div class="card-header">
                                    <div class="container">
                                        ...
                                        <div id="contact">
                                            <fieldset>
                                                <p style="text-align: center;color: #ff9d5c; font-size: 30px;font-weight: bold; ">Add Institute</p>
                                            ...
                                            <fieldset>
                                                <p style="color: #ff9d5c; font-size: 22px;font-weight: bold; ">Institute Name</p>
                                                <input placeholder="Enter Full Name" id="institute_name" type="text" name="institute_name" tabindex="1" required autofocus />
                                            </fieldset>
                                            <br />
                                            <fieldset>
                                                <p style="color: #ff9d5c; font-size: 22px;font-weight: bold; ">Abbreviation</p>
                                                <input placeholder="Enter Institute Abbreviation" id="institute_abbreviation" type="text" name="institute_abbreviation" tabindex="1" required autofocus />
                                            </fieldset>
                                            <br />
                                            <fieldset>
                                                <p style="color: #ff9d5c; font-size: 22px;font-weight: bold; ">Institute Address</p>
                                                <input placeholder="Enter Location" id="address" type="text" name="institute_address" tabindex="1" required autofocus />
                                            </fieldset>
                                            <br />
                                            <fieldset>
                                                <p style="color: #ff9d5c; font-size: 22px;font-weight: bold; ">Institute Website Link</p>
                                                <input placeholder="Enter Website URL" id="website" type="text" name="institute_url" tabindex="1" required autofocus />
                                            </fieldset>
                                            <br />

                                            <fieldset>
                                                <input type="submit" onclick="submit()" id="submit" value="Add Institute" style=" font-size: 15px; padding: 10px 25px;background-color: #ff9d5c; color: white;border-radius: 8px;border: #ff9d5c;" />
                                            </fieldset>
                                        </div>
                                    </div>
                            </form>
    ...
    var institute = document.getElementById("institute_name").value;
    var institute_abbr = document.getElementById("institute_abbreviation").value;
    var institutePattern = /[!@#$%^&*()+\=\[\]{};':"\\|,.<>\/?0-9]+/;

    if (institutePattern.test(institute)) {
        event.preventDefault(); // Prevent form submission
        alert("Institute Name should not contain any special characters or numbers");
    }
    else if (institutePattern.test(institute_abbr)) {
        event.preventDefault(); // Prevent form submission
        alert("Institute Abbreviation should not contain any special characters or numbers");
    }
});
</script>
