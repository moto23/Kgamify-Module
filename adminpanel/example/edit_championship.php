                ...
                <div class="container">
                  ...
                  <div id="contact">
                    ...
                    <fieldset>
                      ...
                      <input placeholder="Enter Championship Name" id="championship_name" type="text" tabindex="1" readonly="readonly" disabled="disabled" style="background-color: rgb(235, 235, 235);" required autofocus />
                    </fieldset>
                    <br />
                    <!-- ended 1st one -->
                    ...
                    <fieldset>
                      ...
                      <input placeholder="Enter Qualification." id="qualification" type="text" tabindex="1" required autofocus />
                    </fieldset>
                    <br />

                    <fieldset>
                      <p style="color: #ff9d5c; font-size: 22px; width: 100%;font-weight: bold; ">Total Coins</p>
                      <input placeholder="Enter Number of Coins" id="total_coins" type="text" tabindex="1" required autofocus />
                    </fieldset>
                    <br />
                    ...
                    <fieldset>
                      ...
                      <input placeholder="Enter Number of Questions" id="n_questions" type="text" tabindex="1" required autofocus />
                    </fieldset>
                    <br />
                    ...
                    <fieldset>
                      ...
                      <input placeholder="Enter Time Required (In Minutes)" id="t_required" type="text" tabindex="1" required autofocus />
                    </fieldset>
                    <br />
