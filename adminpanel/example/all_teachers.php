...
if (isset($_POST['updateteacher'])) {
    ...
    $email = $_POST['email'];
    $phone = $_POST['phone'];
    $query = "UPDATE teacher set teacher_name='$teacher_name' ,username='$username',email='$email',phone='$phone' where teacher_id='$teacher_id'";
    $query_run = mysqli_query($conn, $query);

    if ($query_run) {
        echo "<script>alert('Details Updated');
        window.location.href='all_teachers.php';
        </script>";
...
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
    <title>ALL TEACHERS | PlayQuest</title>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Edit Teacher Data</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form action="all_teachers.php" method="POST">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" name="updateteacher" class="updatebtn" style="font-size: 15px; padding: 5px 8px;background-color:#ff9d5c;border: #ff9d5c;border-radius:5px;color:white;font-weight:bold;">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
                            ...
                            <div class="card-header">
                                <div class="container">
                                    ...
                                    <div id="contact">
                                        ...
                                        <fieldset>
                                            <p style="text-align: center;color: #ff9d5c; font-size: 30px;font-weight: bold; ">Teachers List</p>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><a class="editbtn">
                                                                    <i class="fas fa-solid fa-pen-to-square" style="color:#ff9d5c;margin-right:8px;cursor:pointer;"></i></a>
                                                                <!--<a class="deletebtn">-->
                                                                <!--    <i class="fas fa-solid fa-trash" style="color:#ff9d5c;margin-left:8px;cursor:pointer;"></i></a>-->
                                                            </td>
                                                            ...
                                                            if($status == 0)
                                                            { echo '<a href="status_teacher.php?teacher_id=' . $teacher_id . '&status=1&email=' . urlencode($teacher_email) . '&name=' . urlencode($teacher_name) . '"><button type="button" style="background-color:#5cb85c;color:#fff;border-color: #5cb85c;border-radius:5px;padding:5px 5px;font-weight:bold;font-size:10px" class="success_btn">ACTIVATE</button></a>'; }
                                                            else{
                                                              echo '<a href="status_teacher.php?teacher_id=' . $teacher_id . '&status=0&email=' . urlencode($teacher_email) . '&name=' . urlencode($teacher_name) . '"><button type="button" style="background-color:#da190b;color:#fff;border-color: #da190b;border-radius:5px;padding:5px 5px;font-weight:bold;font-size:10px" class="danger_btn">DEACTIVATE</button></a>';
                                                            }?>
                                                          </td>
