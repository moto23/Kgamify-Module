...
$res = mysqli_query($conn, "select * from add_company");
...
if (isset($_POST['updatecompany'])) {
    ...
    $company_phone = $_POST['company_phone_number'];
    $company_website = $_POST['company_website'];
    $company_desc = $_POST['company_description'];
    $c_person_name = $_POST['contact_person_name'];
    $c_person_email = $_POST['contact_person_email'];
    $c_person_phone = $_POST['contact_person_phone'];
    $query = "UPDATE add_company set company_name='$company_name',company_address='$company_address',company_phone_number='$company_phone',company_website='$company_website',company_description='$company_desc',contact_person_name='$c_person_name',contact_person_email='$c_person_email',contact_person_phone='$c_person_phone' where company_id='$company_id'";
    $query_run = mysqli_query($conn, $query);

    if ($query_run) {
        echo "<script>alert('Company Details Updated');window.location.href='all_companies.php';</script>";
    } else {
        echo '<script>alert("Company Not Updated");</script>';
    }
}

if (isset($_POST['deleteadvertisment'])) {
    // $label_name = $_POST['label_name'];
    $delete_id = $_POST['id'];
    $query = "DELETE from add_company where id='$delete_id'";
    $query_run = mysqli_query($conn, $query);

    if ($query_run) {
        echo '<script>alert("Institute Deleted");</script>';
    } else {
        echo '<script>alert("Institute Not Deleted");</script>';
    }
}
?>
...
<head>
    ...
    <title>All Companies | KGAMIFY</title>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar" data-color="white" data-active-color="danger">
            <div style="display: flex; flex-direction: column; align-items: center" class="logo">
                <!-- logo -->
                <a href="#" class="">
                    <div style="width: 244px; height: 83px" class="logo-image-small">
            ...
            <div class="modal" id="editmodal" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="all_companies.php" method="POST">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" name="updatecompany" class="updatebtn" style="font-size: 15px; padding: 5px 8px;background-color:#ff9d5c;border: #ff9d5c;border-radius:5px;color:white;font-weight:bold;">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
                            ...
                            <div class="card-header">
                                <div class="container">
                                    ...
                                    <div id="contact">
                                        ...
                                        <fieldset>
                                            <p style="text-align: center;color: #ff9d5c; font-size: 30px;font-weight: bold; ">Companies List</p>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="editbtn">
                                                        <i class="fas fa-solid fa-pen-to-square" style="color:#ff9d5c;margin-right:10px;cursor:pointer;"></i>
                                                    </a>
                                                </td>
                                                <td><?php echo $row['company_name']; ?></td>
                                                <td><?php echo $row['company_address']; ?></td>
                                                <td><?php echo $row['company_phone_number']; ?></td>
                                                <td><?php echo '<a style="color: #ff9d5c;font-weight: bold;" href="' . $row['company_website'] . '">Click Here</a>'; ?></td>
                                                <td><?php echo '<a style="color: #ff9d5c;font-weight: bold;" href="' . $row['company_description'] . '">Click Here</a>'; ?></td>
        ...
        <script>
            $(document).ready(function() {
                $('.editbtn').on('click', function() {
                    ...
                    $('#company_address').val(data[4]);
                    $('#company_phone_number').val(data[5]);
                    $('#company_website').val();
                    $('#company_description').val();
                    $('#contact_person_name').val(data[8]);
                    $('#contact_person_email').val(data[9]);
                    $('#contact_person_phone').val(data[10]);
                });
            });
        </script>
