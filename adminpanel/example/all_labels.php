                          ...
                          ?>
                            <tr>
                              ...
                              <td><?php $status = $row['status'];
                                ...
                                if($status == 0)
                                { echo '<a href="status_label.php?label_id='.$label_id.'&status=1"><button type="button" style="background-color:#5cb85c;color:#fff;border-color: #5cb85c;border-radius:5px;padding:5px 5px;font-weight:bold;font-size:10px" class="success_btn">ACTIVATE</button></a>'; }
                                else{
                                  echo '<a href="status_label.php?label_id='.$label_id.'&status=0"><button type="button" style="background-color:#da190b;color:#fff;border-color: #da190b;border-radius:5px;padding:5px 5px;font-weight:bold;font-size:10px" class="danger_btn">DEACTIVATE</button></a>';
                                }?>
                              </td>
