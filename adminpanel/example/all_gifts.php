...
$res = mysqli_query($conn, "select * from gift");
...
if (isset($_POST['updategift'])) {
    ...
    $gift_desc = $_POST['gift_description'];
    $query = "UPDATE gift set gift_type='$gift_type',gift_description='$gift_desc' where gift_id='$gift_id'";
    $query_run = mysqli_query($conn, $query);

    if ($query_run) {
        echo "<script>alert('Gift Type Changed');window.location.href='all_gifts.php';</script>";
    } else {
        echo '<script>alert("Gift Type Not Updated");</script>';
    }
}
...
if (isset($_POST['deletedepartment'])) {
    ...
    $query = "DELETE from department where department_id='$delete_id'";
    $query_run = mysqli_query($conn, $query);
...
<head>
    ...
    <title>ALL GIFTS | PlayQuest</title>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Change Gift</h5>
                        ...
                        <form action="all_gifts.php" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="gift_type" name="gift_type">
                                    <label>Gift Description</label>
                                    <input type="text" class="form-control" id="gift_description" name="gift_description">
                                </div>
                            </div>
                            <div class="modal-footer">
                                ...
                                <button type="submit" name="updategift" class="updatebtn" style="font-size: 15px; padding: 5px 8px;background-color:#ff9d5c;border: #ff9d5c;border-radius:5px;color:white;font-weight:bold;">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
                            ...
                            <div class="card-header">
                                <div class="container">
                                    ...
                                    <div id="contact">
                                        ...
                                        <fieldset>
                                            <p style="text-align: center;color: #ff9d5c; font-size: 30px;font-weight: bold; ">Gifts</p>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $row['gift_description'] ?></td>
        ...
        <script>
            $(document).ready(function() {
                $('.editbtn').on('click', function() {
                    ...
                    $('#srno').val(data[0]);
                    $('#gift_id').val(data[1]);
                    $('#gift_type').val(data[3]);
                    $('#gift_description').val(data[4]);
                });
            });
        </script>
