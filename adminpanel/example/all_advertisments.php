...
$res = mysqli_query($conn, "select * from add_advertisment");
if ($conn->connect_error) {
    die("Connection failed: " . $conn->connect_error);
}

if (isset($_POST['updateadvertisment'])) {
    $advertisement_id = $_POST['advertisement_id'];
    $title = $_POST['title'];
    $ad_description = $_POST['ad_description'];
    $ad_link = $_POST['ad_link'];
    $query = "UPDATE add_advertisment set title='$title',ad_description='$ad_description',ad_link='$ad_link' where advertisement_id='$advertisement_id'";
    $query_run = mysqli_query($conn, $query);

    if ($query_run) {
        echo "<script>alert('Advertisment Updated');window.location.href='all_advertisments.php';</script>";
    } else {
        echo '<script>alert("Advertisment Not Updated");</script>';
    }
}
...
if (isset($_POST['deleteadvertisment'])) {
    ...
    $delete_id = $_POST['id'];
    $query = "DELETE from add_advertisment where id='$delete_id'";
    $query_run = mysqli_query($conn, $query);
...
<head>
    ...
    <title>All Advertisements | KGAMIFY</title>
            ...
            <div class="modal" id="editmodal" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="all_advertisments.php" method="POST">
                            <div class="modal-body">
                                <input type="hidden" name="srno" id="srno">
                                <input type="hidden" name="advertisment_id" id="advertisment_id">
                                <div class="form-group">
                                    <label>Advertisement Title</label>
                                    <input type="text" class="form-control" id="title" name="title">
                                    <label>Advertisement Description</label>
                                    <input type="text" class="form-control" id="ad_description" name="ad_description">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" name="updateadvertisment" class="updatebtn" style="font-size: 15px; padding: 5px 8px;background-color:#ff9d5c;border: #ff9d5c;border-radius:5px;color:white;font-weight:bold;">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
                            ...
                            <div class="card-header">
                                <div class="container">
                                    ...
                                    <div id="contact">
                                        ...
                                        <fieldset>
                                            <p style="text-align: center;color: #ff9d5c; font-size: 30px;font-weight: bold; ">Advertisments List</p>
                                            ...
                                            <table id="myTable" class="table-striped cell-border">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Advertisment Description</th>
                                                        <th>Advertisment Image</th>
                                                        <th>Advertisment Link</th>
                                                        <th>Creation Time</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo '<a style="color: #ff9d5c;font-weight: bold;" href="', $row['ad_link'], '">Click Here</a>' ?></td>
        ...
        <script>
            $(document).ready(function() {
                $('.editbtn').on('click', function() {
                    ...
                    $('#srno').val(data[0]);
                    $('#advertisement_id').val(data[1]);
                    $('#title').val(data[4]);
                    $('#ad_description').val(data[5]);
                    $('#ad_link').val(data[7]);
                });
            });
        </script>
