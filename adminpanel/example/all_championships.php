...
$res = mysqli_query($conn, "select * from championship");
...
<head>
  ...
  <title>ALL CHAMPIONSHIPS | PlayQuest</title>
                          ...
                          ?>
                            <tr>
                              ...
                              <td><?php $status = $row['status'];
                                ...
                                if($status == 0)
                                { echo '<a href="status_championship.php?champ_id='.$champ_id.'&status=1"><button type="button" style="background-color:#5cb85c;color:#fff;border-color: #5cb85c;border-radius:5px;padding:5px 5px;font-weight:bold;font-size:10px" class="success_btn">ACTIVATE</button></a>'; }
                                else{
                                  echo '<a href="status_championship.php?champ_id='.$champ_id.'&status=0"><button type="button" style="background-color:#da190b;color:#fff;border-color: #da190b;border-radius:5px;padding:5px 5px;font-weight:bold;font-size:10px" class="danger_btn">DEACTIVATE</button></a>';
                                }?>
                              </td>
    ...
    <script>
      $(document).ready(function() {
        $('.editbtn').on('click', function() {
          ...
          $('#srno').val(data[0]);
          $('#champ_id').val(data[1]);
          $('#champ_name').val(data[6]);
          $('#start_date').val(data[7]);
          $('#end_date').val(data[9]);
          $('#start_time').val(data[8]);
          $('#end_time').val(data[10]);
        });
      });
    </script>
