...
$res = mysqli_query($conn, "select * from champ_config");
...
if (isset($_POST['updateconfig'])) {
  ...
  $query = "UPDATE champ_config set complexity='$complexity',coin_value='$coin_value' where id='$id'";
  $query_run = mysqli_query($conn, $query);

  if ($query_run) {
    echo "<script>alert('Values Updated');window.location.href='all_configs.php';</script>";
  } else {
    echo '<script>alert("Values Not Updated");</script>';
  }
}
...
<head>
  ...
  <title>ALL CONFIGS | KGamify</title>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">Edit Champ Config</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="all_configs.php" method="POST">
              ...
              <div class="modal-footer">
                ...
                <button type="submit" name="updateconfig" class="updatebtn" style="font-size: 15px; padding: 5px 8px;background-color:#ff9d5c;border: #ff9d5c;border-radius:5px;color:white;font-weight:bold;">Update</button>
              </div>
            </form>
          </div>
        </div>
              ...
              <div class="card-header">
                <div class="container">
                  ...
                  <div id="contact">
                    ...
                    <fieldset>
                      <p style="text-align: center;color: #ff9d5c; font-size: 30px;font-weight: bold; ">Configurations List</p>
    ...
    <script>
      $(document).ready(function() {
        $('.editbtn').on('click', function() {
          ...
          $('#srno').val(data[0]);
          $('#id').val(data[1]);
          $('#complexity').val(data[3]);
          $('#coin_value').val(data[4]);
        });
      });
    </script>
