...
if (isset($_POST['updatecategory'])) {
  ...
  if ($query_run) {
    echo "<script>alert('Category Updated');window.location.href='all_category.php';</script>";
  } else {
...
<head>
  ...
  <title>ALL CATEGORY | PlayQuest</title>
      ...
      <div class="modal" id="editmodal" tabindex="-1">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form action="all_category.php" method="POST">
              ...
              <div class="modal-footer">
                ...
                <button type="submit" name="updatecategory" class="updatebtn" style="font-size: 15px; padding: 5px 8px;background-color:#ff9d5c;border: #ff9d5c;border-radius:5px;color:white;font-weight:bold;">Update</button>
              </div>
            </form>
          </div>
        </div>
              ...
              <div class="card-header">
                <div class="container">
                  ...
                  <div id="contact">
                    ...
                    <fieldset>
                      <p style="text-align: center;color: #ff9d5c; font-size: 30px;font-weight: bold; ">Categories List</p>
                          ...
                          ?>
                            <tr>
                              ...
                              <td><?php $status = $row['status'];
                                ...
                                if($status == 0)
                                { echo '<a href="status_category.php?category_id='.$category_id.'&status=1"><button type="button" style="background-color:#5cb85c;color:#fff;border-color: #5cb85c;border-radius:5px;padding:5px 5px;font-weight:bold;font-size:10px" class="success_btn">ACTIVATE</button></a>'; }
                                else{
                                  echo '<a href="status_category.php?category_id='.$category_id.'&status=0"><button type="button" style="background-color:#da190b;color:#fff;border-color: #da190b;border-radius:5px;padding:5px 5px;font-weight:bold;font-size:10px" class="danger_btn">DEACTIVATE</button></a>';
                                }?>
                              </td>
