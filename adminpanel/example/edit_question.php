                ...
                <div class="container">
                  ...
                  <div id="contact">
                    ...
                    <fieldset>
                      ...
                      <input placeholder="Enter Option 1" id="option_1" type="text" tabindex="1" required autofocus />
                    </fieldset>
                    <br />

                    <fieldset>
                      <p style="color: #ff9d5c; font-size: 22px; width: 100%;font-weight: bold; ">Option 2</p>
                      <input placeholder="Enter Option 2" id="option_2" type="text" tabindex="1" required autofocus />
                    </fieldset>
                    <br />

                    <fieldset>
                      <p style="color: #ff9d5c; font-size: 22px; width: 100%;font-weight: bold; ">Option 3</p>
                      <input placeholder="Enter Option 3" id="option_3" type="text" tabindex="1" required autofocus />
                    </fieldset>
                    <br />

                    <fieldset>
                      <p style="color: #ff9d5c; font-size: 22px; width: 100%;font-weight: bold; ">Option 4</p>
                      <input placeholder="Enter Option 4" id="option_4" type="text" tabindex="1" required autofocus />
                    </fieldset>
                    <br />
