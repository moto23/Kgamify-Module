...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $ut_text = $_POST['ut_text'];
    
    // Use prepared statement to insert data safely
    $insert_query = "INSERT INTO privacy_user (add_user_privacy) VALUES (?)";
    $insert_stmt = $conn->prepare($insert_query);

    if ($insert_stmt) {
        $insert_stmt->bind_param("s", $ut_text);
        $insert_stmt->execute();
        $insert_stmt->close();
...
<head>
  ...
  <title>ADD TEACHER HELP | KGAMIFY</title>
...
<body class="">
  <div class="wrapper">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card demo-icons">
              ...
              <!-- form start  -->
              <form action="privacy_user.php" method="post">
                <div class="card-header">
                  <div class="container">
                    ...
                    <div id="contact">
                      <fieldset>
                        <p style="text-align: center;color: #ff9d5c; font-size: 30px;font-weight: bold; ">Add Terms and Conditions for User Panel</p>

                        <hr style="height:1px; border:none;  background-color:#ff9d5c;">
                        <br>
                      </fieldset>
               
                      <form action="privacy_user.php" method="post" enctype="multipart/form-data">
    <fieldset>
       
    <fieldset>
        <p style="color: #ff9d5c; font-size: 22px; font-weight: bold;"></p>
        <textarea name="ut_text" id="editor" placeholder="Write Description here...."></textarea>
    </fieldset>
    <br />
    <br>
    ...
    <input type="submit" id="submit" value="Submit Terms and Conditions for User" style="font-size: 15px;font-weight:bold;margin-bottom:1rem; padding: 10px 25px; background-color: #ff9d5c; color: white; border-radius: 8px; border: #ff9d5c;" />
</form>
