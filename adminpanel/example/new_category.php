...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['category_name'])) {
        ...
        if ($stmt) {
            ...
            if ($count > 0) {
                echo "<script>alert('Category name already exists'); 
                ...
                if ($stmt) {
                    ...
                    if ($execval) {
                        ...
                        $query = "UPDATE category SET unique_id='" . $unique_id . "' WHERE category_id='" . $last_id . "'";
        ...
        echo "<script>alert('Category name not entered'); 
                window.location.href = 'new_category.php';
                </script>";
    }
}
...
<body>
                  ...
                  <div class="container">
                    ...
                    <div id="contact">
                      ...
                      <fieldset>
                        ...
                        <input placeholder="Enter Category Name" id="category_name" type="text" name="category_name" tabindex="1" required autofocus />
                        <span id="category-check" style="color: red;"></span>
                      </fieldset>
                      <br />
  ...
  <script>
    ...
    var messageElement = document.getElementById("category-check");
    var categoryPattern = /[!@#$%^&*()+\=\[\]{};':"\\|,.<>\/?0-9]+/;

    if (categoryPattern.test(category)) {
        event.preventDefault(); // Prevent form submission
        alert("Category Name should not contain any special characters or numbers");
    }
});
</script>
</body>
