...
$res = mysqli_query($conn, "select * from institute");
...
if (isset($_POST['updateinstitute'])) {
    ...
    $query = "UPDATE institute set institute_name='$institute_name',institute_abbreviation='$institute_abbr',institute_address='$institute_address',institute_url='$institute_url' where institute_id='$institute_id'";
    $query_run = mysqli_query($conn, $query);

    if ($query_run) {
        echo "<script>alert('Institute Updated');
        window.location.href='all_institutes.php';
        </script>";
        
    } else {
        echo '<script>alert("Institute Not Updated");</script>';
    }
}

if (isset($_POST['deleteinstitute'])) {
    // $label_name = $_POST['label_name'];
    $delete_id = $_POST['institute_id'];
    $query = "DELETE from institute where institute_id='$delete_id'";
    $query_run = mysqli_query($conn, $query);
...
<head>
    ...
    <title>ALL INSTITUTES | PlayQuest</title>
                        ...
                        <form action="all_institutes.php" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="institute_abbr" name="institute_abbreviation">
                                    <label>Institute Address</label>
                                    <input type="text" class="form-control" id="institute_address" name="institute_address">
                                    <label>Website Link</label>
                                    <input type="text" class="form-control" id="institute_url" name="institute_url">
                                </div>
                            </div>
                            <div class="modal-footer">
                                ...
                                <button type="submit" name="updateinstitute" class="updatebtn" style="font-size: 15px; padding: 5px 8px;background-color:#ff9d5c;border: #ff9d5c;border-radius:5px;color:white;font-weight:bold;">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
                            ...
                            <div class="card-header">
                                <div class="container">
                                    ...
                                    <div id="contact">
                                        ...
                                        <fieldset>
                                            <p style="text-align: center;color: #ff9d5c; font-size: 30px;font-weight: bold; ">Institutes List</p>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo '<a style="color: #ff9d5c;font-weight: bold;" href="', $row['institute_url'], '">Click Here</a>' ?></td>
        ...
        <script>
            $(document).ready(function() {
                $('.editbtn').on('click', function() {
                    ...
                    $('#srno').val(data[0]);
                    $('#institute_id').val(data[1]);
                    $('#institute_name').val(data[3]);
                    $('#institute_abbr').val(data[4]);
                    $('#institute_address').val(data[5]);
                    $('#institute_url').val();
                    $('#action').val(data[6]);
