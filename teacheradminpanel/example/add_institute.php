...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['institute_name'])) {
        ...
        $stmt = $conn->prepare("INSERT INTO institute (institute_name) VALUES (?)");
                                    ...
                                    <div class="container">
                                        ...
                                        <div id="contact">
                                            ...
                                            <fieldset>
                                                ...
                                                <input placeholder="Enter Institute Name" id="institute_name" type="text" name="institute_name" tabindex="1" required autofocus />
                                            </fieldset>
                                            <br />
