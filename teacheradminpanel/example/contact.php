...
<body class="">
  <div class="wrapper">
    <div class="sidebar" data-color="white" data-active-color="danger">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="active">
            <a href="#">
              <p style="color: rgb(255, 81, 0); font-size: 15px">Help?</p>
            </a>
          </li>
      ...
      <nav class="
        ...
        <div class="container-fluid" style="margin-bottom: 10px">
          <div class="navbar-wrapper">
            ...
            <a style="color: orange; font-size: 25px" class="navbar-brand" href="javascript:;">Contact</a>
          </div>
    ...
    <!--        <p name="a_text"><?php echo ($_SESSION['add_teacher_help']); ?></p>-->
    <!--    </div>-->
    <!--    <br />-->
    <!--    <br>-->
