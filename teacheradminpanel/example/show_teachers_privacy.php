...
if ($result->num_rows > 0) {
    ...
    $_SESSION['add_teacher_privacy'] = $row['add_teacher_privacy'];
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card demo-icons">
              ...
              <!-- form start  -->
             <form method="post" action="show_teachers_privacy.php">
                <div class="card-header">
                  <div class="container">
                    ...
                    <div id="contact">
                      <fieldset>
                        <p style="text-align: center;color: #ff9d5c; font-size: 30px;font-weight: bold; ">Terms and Conditions</p>

                        <hr style="height:1px; border:none;  background-color:#ff9d5c;">
                        <br>
                      </fieldset>
               <form action="show_teachers_privacy.php" method="post" enctype="multipart/form-data">
        <div>
            <p style="color: #ff9d5c; font-size: 22px; font-weight: bold;"></p>
            <p name="a_text"><?php echo nl2br($_SESSION['add_teacher_privacy']); ?></p>
        </div>
        <br />
        <br>
